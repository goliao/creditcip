...
dfout %>% dplyr::as.tbl(.) %>% select(date,er30_govtoas) %>% summary()
...
setwd("/Users/gliao/Dropbox/Research/ccy basis/data/datadownloads160308/")
filenames<-c('BAML_USD_160308.csv','BAML_EUR_160308.csv','BAML_GBP_160308.csv','BAML_JPYplus_160308.csv','BAML_AUDplus_160308.csv','BAML_CAD_160308.csv')
...
write.dta(dfout,'baml_indices_160308.dta')
write.dta(dfout,'/Users/gliao/Dropbox/Research/ccy basis/creditmigration/baml_indices_160308.dta')
