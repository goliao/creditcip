...
rm reg_40_5.csv
quietly: ireg2 "USD" "EUR" "us" "eu" "40" "eubs10" "40_5" D.eubsc `controls'
quietly: ireg2 "USD" "GBP" "us" "gb" "40" "bpbs10" "40_5" D.bpbsc `controls'
quietly: ireg2 "USD" "JPY" "us" "jp" "40" "jybs10" "40_5" D.jybsc `controls'
quietly: ireg2 "USD" "AUD" "us" "au" "40" "adbs10" "40_5" D.adbsf `controls'
...
***** quarterly basis chg!!!
collapse (last) *bs* Cdif* (mean) i_* I_*, by(qrt)
ds *,v(32)
capture program drop iregbasis
