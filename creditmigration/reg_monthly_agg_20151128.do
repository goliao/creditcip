...
drop if secur=="Asset Backd Nts" | secur=="Preferred Shs"
drop if amt==.
...
rm reg_30_13.csv
quietly: ireg2 "USD" "EUR" "us" "eu" "30" "eubs10" "30_13" D.eubs1 `controls'
quietly: ireg2 "USD" "GBP" "us" "gb" "30" "bpbs10" "30_13" D.bpbs1 `controls'
quietly: ireg2 "USD" "JPY" "us" "jp" "30" "jybs10" "30_13" D.jybs1 `controls'
quietly: ireg2 "USD" "AUD" "us" "au" "30" "adbs10" "30_13" D.adbs1 `controls'
* quietly: ireg2 "EUR" "AUD" "eu" "au" "40" "aebs10" "40_5" D.aebs1 `controls'
* quietly: ireg2 "EUR" "GBP" "eu" "gb" "40" "gebs10" "40_5" D.gebs1 `controls'
* quietly: ireg2 "EUR" "JPY" "eu" "jp" "40" "jebs10" "40_5" D.jebs1 `controls'
* quietly: ireg2 "JPY" "AUD" "jp" "au" "40" "ajbs10" "40_5" D.ajbs1 `controls'

* capture program drop iregbasis
* rm reg_basis30_4.csv
* quietly: iregbasis "USD" "EUR" "us" "eu" "30" "eubs" "basis30_4" `controls'
* quietly: iregbasis "USD" "GBP" "us" "gb" "30" "bpbs" "basis30_4" `controls'
* quietly: iregbasis "USD" "JPY" "us" "jp" "30" "jybs" "basis30_4" `controls'
* quietly: iregbasis "USD" "AUD" "us" "au" "30" "adbs" "basis30_4" `controls'
* quietly: iregbasis "EUR" "AUD" "eu" "au" "30" "aebs" "basis30_4" `controls'
* quietly: iregbasis "EUR" "GBP" "eu" "gb" "30" "gebs" "basis30_4" `controls'
* quietly: iregbasis "EUR" "JPY" "eu" "jp" "30" "jebs" "basis30_4" `controls'
* quietly: iregbasis "JPY" "AUD" "jp" "au" "30" "ajbs" "basis30_4" `controls'
